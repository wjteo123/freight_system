...
def generate_booking_reference(db: Session):
    """
    Generates a running number like BKG-2025-0001
    """
    current_year = datetime.now().year
    prefix = f"BKG-{current_year}"
    
    # Count how many bookings exist for this year to increment
...
def create_shipment(db: Session, shipment: schemas.ShipmentCreate, user_id: int):
    ...
    while attempts < 3:
        ...
        # Explicitly map fields to ensure everything is covered
